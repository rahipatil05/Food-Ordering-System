   ...
   <main>
       ...
       <header class="stick">
           <div class="topbar">
               <div class="container">
                   ...
                   <div class="social1">
                       ...
                       <a href="https://www.instagram.com/_rahipatil_5?igsh=bTRhc2h4ZWtjOGJz" title="instagram" itemprop="url" target="_blank"><i class="fa fa-instagram"></i></a>
           ...
           <div class="logo-menu-sec">
               <div class="container">
                   <div class="logo">
                       <h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url">FOS</a></h1>
                   </div>
                   <nav>
                       <div class="menu-sec">
                           <ul>
       ...
       <div class="responsive-header">
           ...
           <div class="responsive-logomenu">
               <div class="logo">
                   <h1 itemprop="headline"><a href="index-2.html" title="Home" itemprop="url">Innova</h1>
               </div>
               <span class="menu-btn yellow-bgg brd-rd4"><i class="fa fa-align-justify"></i></span>
           </div>
