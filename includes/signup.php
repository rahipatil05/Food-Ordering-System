          ...
          <div class="sign-popup-inner brd-rd5">
              ...
              <form class="sign-form" name="signup" onsubmit="return checkpass();" method="post">
                  <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 col-lg-12">
                          <input class="brd-rd3" type="password" id="password" name="password" required
                              pattern="(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{8,}"
                              title="Minimum 8 characters, with 1 uppercase letter, 1 number, and 1 special character."
